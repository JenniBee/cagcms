...
# manage your downloadable items.  You can use this file to set #
# up mirrored downloads, you can upload files to the server, if #
# enabled in your admin settings, and you can monitor the       #
...
elseif($_POST{'savescreen'} == $admin_ans[7]) {
	...
	<form name='screenedit' method='post' action='$cagcmsadmin?action=addscreens'>
		...
		<h3>$rs[title]</h3>
		<dl>
			<dt><label for='pageid$imgid'>$admin_addscreenstxt[6]</label></dt>
			<dd>
			...
			<dt><label for='location_thumb$imgid'>$admin_addscreenstxt[11]</label><img src='$imgdir/question.png' alt='?' onmouseover='return escape(\"".removequotes($admin_addscreenstxt{'11a'})."\")' border='0' /></dt>
			<dd>
				<input type='text' name='location_thumb[$imgid]' id='location_thumb$imgid' value='$rs[location_thumb]' />
			</dd>
			<dt><label for='location$imgid'>$admin_addscreenstxt[7]</label><img src='$imgdir/question.png' alt='?' onmouseover='return escape(\"".removequotes($admin_addscreenstxt{'7a'})."\")' border='0' /></dt>
			<dd>
				<input type='text' name='location[$imgid]' id='location$imgid' value='$rs[location]' />
			</dd>
			<dt><label for='title$imgid'>$admin_addscreenstxt[8]</label><img src='$imgdir/question.png' alt='?' onmouseover='return escape(\"".removequotes($admin_addscreenstxt{'8a'})."\")' border='0' /></dt>
			<dd>
				<input type='text' name='title[$imgid]' id='title$imgid' value='$rs[title]' />
			</dd>
			<dt><label for='caption$imgid'>$admin_addscreenstxt[12]</label><img src='$imgdir/question.png' alt='?' onmouseover='return escape(\"".removequotes($admin_addscreenstxt{'12a'})."\")' border='0' /></dt>
			<dd>
		...
		$cgadmin .= "
		<input type='submit' name='savescreen' value='$admin_ans[13]' />
	</form>
	</div>";
...
elseif($_POST{'savescreen'} == $admin_addscreenstxt[4]) {
	...
	for($i=1;$i<=$_POST{'itemnum'};$i++) {
		...
		$cgadmin .= "
			...
			<dt><label for='title$pageid'>$admin_addscreenstxt[8]</label><img src='$imgdir/question.png' alt='?' onmouseover='return escape(\"".removequotes($admin_addscreenstxt{'8a'})."\")' border='0' /></dt>
			<dd>
				<input type='text' name='title[$imgid]' id='title$imgid' />
			</dd>
			<dt><label for='caption$pageid'>$admin_addscreenstxt[12]</label><img src='$imgdir/question.png' alt='?' onmouseover='return escape(\"".removequotes($admin_addscreenstxt{'12a'})."\")' border='0' /></dt>
			<dd>
	...
	$cgadmin .= "
		<input type='submit' name='savescreen' value='$admin_addscreenstxt[10]' />
	</form>
	</div>";
